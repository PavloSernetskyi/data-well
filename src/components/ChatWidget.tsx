...
//                     👋 Hi! I'm your DataWell assistant. Ask me anything about the data, like:
//                   </p>
//                   <ul className="text-xs text-gray-600 mt-2 space-y-1">
//                     <li>• "Show me all female users under 25"</li>
//                     <li>• "What's the average weight in California?"</li>
//                     <li>• "How many users drink more than 5 drinks per week?"</li>
//                   </ul>
//                 </div>
//               </div>
//             </div>
